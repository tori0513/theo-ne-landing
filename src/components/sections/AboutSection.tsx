        ...
        <div className="border border-charcoal/10 p-10 lg:p-14 bg-white/50 text-center flex flex-col items-center">
          ...
          <div className="space-y-10 flex flex-col items-center w-full">
            ...
            <div className="space-y-6">
              {/* 
                1. 폰트 사이즈를 다른 섹션과 동일하게 축소 (text-sm md:text-base)
                2. dangerouslySetInnerHTML을 사용하여 JSON의 <strong> 태그를 화면에 렌더링
              */}
              <div 
                className="text-sm md:text-base leading-relaxed text-charcoal/80 max-w-2xl text-balance whitespace-pre-line"
                dangerouslySetInnerHTML={{ __html: t('about.identity') }}
              />
              ...
              <div className="flex items-center justify-center mt-6">
                <a 
                  ...
                  title="LinkedIn"
                >
                  <span className="mr-1 underline underline-offset-4 text-xs md:text-sm">{t('about.linkedinBtn')}</span>
